...
namespace AuthenticatedSchoolSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            SignInStatus result = await SignInManager.PasswordSignInAsync(model.Email, model.Password, model.RememberMe,
                false);
            switch (result)
            {
        ...
        public async Task<ActionResult> VerifyCode(string provider, string returnUrl, bool rememberMe)
        {
            ...
            return !await SignInManager.HasBeenVerifiedAsync()
                ? View("Error")
                : (ActionResult)View(new VerifyCodeViewModel
        ...
        {
            ViewBag.Name = new SelectList(ApplicationDbContextcontext.Roles.ToList(), "Name", "Name");
            ViewBag.UserName = new SelectList(ApplicationDbContextcontext.Users.ToList(), "UserName", "UserName");
            return View();
        }
        ...
        {
            IQueryable<string> userId = ApplicationDbContextcontext.Users.Where(i => i.UserName == user.UserName)
                .Select(s => s.Id);
            string updateId = "";
            ...
            //assign roles
            _ = await UserManager.AddToRolesAsync(updateId, model.Name);
            // If we got this far, something failed, redisplay form
            return RedirectToAction("Index", "Home");
        }
        ...
        public async Task<ActionResult> SendCode(string returnUrl, bool rememberMe)
        {
            ...
            System.Collections.Generic.IList<string> userFactors =
                await UserManager.GetValidTwoFactorProvidersAsync(userId);
            System.Collections.Generic.List<SelectListItem> factorOptions = userFactors
